import { Users, ShoppingBag, TrendingUp, AlertTriangle, Clock } from 'lucide-react'
...
const STATS = [
  ...
  { key: 'expiring_medicines_count', label: 'Expiring Soon', icon: Clock, color: 'bg-red-50 text-red-600' },
]
