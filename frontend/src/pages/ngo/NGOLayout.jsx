  ...
  return (
    <div className="flex h-screen overflow-hidden bg-green-50/30">
      ...
      <aside className={clsx(
        'fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-green-100 flex flex-col shadow-sm transition-transform duration-300',
        ...
        <div className="p-4 border-t border-slate-100">
          <Link to="/ngo/profile" onClick={() => setSidebarOpen(false)}
            className="flex items-center gap-3 px-3 py-2.5 mb-2 rounded-xl bg-green-50 border border-green-100 hover:bg-green-100 transition-colors">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-white text-sm font-semibold">
